<!-- Changelog v2:
- Removed all inline backticks (formatting reviewer requirement)
- Added 3 Mermaid diagrams (multi-stage build, S2I comparison)
- Added hero image placeholder and app screenshot placeholder
- Expanded acronyms on first use (SPA, LLM, API, UID)
- Added top and mid-article CTAs linking to redhat.com
- Added redhat.com links throughout
- Changed "three things" to "3 things"
-->
